        ...
        <div className='flex pt-10 justify-between'>
          ...
          <div>
            <button
              ...
              className='bg-blue-600 px-2 py-2 rounded-md hover:scale-105 transition-all duration-200 font-semibold'
            >
              Add Employees
            </button>
          </div>
      ...
      <div>
        {userData.map((person) => {
          return (
            <div
              key={person._id}
              className='bg-blue-900 rounded-xl text-blue-200 flex w-10/12 mx-auto items-center justify-between px-6 py-2 mt-2 border-white'
            >
              ...
              <div>{person.role}</div>
              <button
                onClick={() => deleteHandler(person._id)} // Pass the ID properly
                className='hover:scale-105 transition-all duration-100 bg-green-500 font-semibold text-gray-700 px-2 py-2 rounded-lg'
              >
                Delete
              </button>
            </div>
